...
const handledelete = async()=>{
   await deleteUser(newId as string)
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {
            ...
            (
                ...
                <div className="flex flex-col items-center text-center">
                        <div className='w-full h-full text-2xl font-bold flex items-center justify-center'>
                            User Not Found
                        </div>
                </div>
              </div>
                  ...
                  <div className="bg-white shadow rounded-lg p-6 mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="flex items-center">
                       <button className='bg-red-700 cursor-pointer text-white px-6 py-4 rounded-lg my-4 text-sm' onClick={()=>handledelete()}>
                           Delete User
                       </button>
                        </div>
                      </div>
